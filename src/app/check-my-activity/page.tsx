...
function CheckMyActivity() {
  ...
  return (
    <div className="flex items-center justify-center bg-gray-100 p-1 mt-[63.48px] sm:mt-[90.9px]">
      <div className="p-5 sm:p-10 bg-white text-left shadow-md rounded-lg w-full sm:w-[500px] md:w-[700px] min-h-[calc(100vh-304px)] sm:min-h-[calc(100vh-294px)]">
